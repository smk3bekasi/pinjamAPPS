<?php
	...
	if(isset($_POST['request-pinjam'])){
		...
		$query_insert_req   = mysql_query("INSERT INTO tbl_request (nama_barang, peminjam, level, no_tlp, jml_barang, tgl_pinjam, tgl_kembali) VALUES ('$nama_barang', '$nm_peminjam', '$level', '$no_tlp', '$jml_barang', '$tgl_pinjam', '$tgl_kembali')");
		if($query_insert_req){
