<?php
	...
	if(isset($_GET['mode']) && !empty($_GET['mode'])){
		...
		$notlp_request		 = $data_request['no_tlp'];
		...
		if($_GET['mode'] == "terima"){
			...
			if($data_search_barang){
				...
				if($update_stok){
					if(mysql_query("INSERT INTO tbl_pinjam (nama_barang, peminjam, level, no_tlp, jml_barang, tgl_pinjam, tgl_kembali) VALUES ('$nama_barang_request', '$peminjam_request', '$level_request', '$notlp_request', '$jml_barang_request', '$tgl_pinjam_request', '$tgl_kembali_request')")){
