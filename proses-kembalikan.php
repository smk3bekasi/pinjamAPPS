<?php
	...
	if(isset($_GET['id'])){
		...
		$nm_peminjam			 = $data_pinjam['peminjam'];
		...
		if($query_search_barang){		
			$query_request_kembali = mysql_query("INSERT INTO tbl_req_kembali (nama_barang, peminjam, level, jml_barang, tgl_pinjam, tgl_kembali) VALUES ('$nama_barang', '$nm_peminjam', '$level', '$jml_barang', '$tgl_pinjam', '$tgl_kembali')");
